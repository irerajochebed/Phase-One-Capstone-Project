...
public class LoanService {
    ...
    public Loan applyForLoan(int customerId, int accountId, double amount, String purpose) 
        ...
        System.out.println("[LoanService]  Loan application created: " + loanId);
    ...
    public boolean approveLoan(int loanId, int adminId) throws IgirePayException {
        ...
        System.out.println("[LoanService]  Loan approved and disbursed: " + loanId);
        return true;
    }
    ...
    public boolean rejectLoan(int loanId, String reason) throws IgirePayException {
        ...
        System.out.println("[LoanService]  Loan rejected: " + loanId);
        return true;
    }
    ...
    public boolean repayLoan(int loanId, int accountId, double amount) throws IgirePayException {
        ...
        String title = loan.getRemainingBalance() <= 0 ? " Loan Fully Repaid!" : " Loan Payment Received";
        ...
        System.out.println("[LoanService]  Loan payment recorded: " + amount);
        return true;
    }
    ...
    public int sendPaymentReminders() {
        ...
        System.out.println("[LoanService]  Sent " + remindersSent + " payment reminders");
    ...
    public int sendOverdueNotices() {
        ...
        for (Loan loan : overdueLoans) {
            ...
            String severity = daysOverdue > OVERDUE_GRACE_DAYS ? " URGENT" : " OVERDUE";
            String message = String.format(
                ...
                daysOverdue > OVERDUE_GRACE_DAYS 
                    ? " Your loan has been marked as DEFAULTED. This may affect your ability to borrow in the future."
        ...
        System.out.println("[LoanService]  Sent " + noticesSent + " overdue notices");
        return noticesSent;
    }
